...
<div class="container"><br>
    <div class="col d-grid gap-2 d-md-flex justify-content-md-end">
        <button role="button" class="btn btn-success mt-5" name=""><a href="index.php?page=7" class="text-light">Ajout d'une nouvelle photo</a></button>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center col-1 align-middle">
                        <a href="index.php?page=9&id=<?=$picture['id']?>" onclick="return(confirm('Voulez-vous supprimer cette category ?'))">
